...
const LoginComp = ({users}) => {
  ...
  return (
    <div>
        ...
        <Grid item xs style={window.screen.width > 1000 ? {boxShadow: 'rgb(145 158 171 / 20%) 0px 0px 2px 0px, rgb(145 158 171 / 12%) 0px 12px 24px -4px'} : {boxShadow: 'rgb(145 158 171 / 20%) 0px 0px 2px 0px, rgb(145 158 171 / 12%) 0px 12px 24px -4px' , textAlign : 'center'}}>
        <img alt='logo' src={logo} style={{width: '14%', marginRight: '2rem', marginTop: '2rem'}}/>
